...
class CandidateSkillModel(Base, CommonMixin):
    ...
    candidate = relationship(
        ...
        back_populates="candidate_skills",  # Name of the reverse relationship attribute in CandidateModel that references this junction table
    )
    skill = relationship(
    ...
    def __repr__(self) -> str:  # pragma: no cover - trivial
        return f"<CandidateSkillModel candidate_id={self.candidate_id} skill_id={self.skill_id} proficiency='{self.proficiency_level}'>"
